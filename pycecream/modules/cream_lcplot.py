...
logger = logging.getLogger("cream_lcplot")
 ...
 """
    ...
    for idnow in range(ndres):
        ...
        try:
            ...
            fileoutrej = [
                dnow + "/plots/data_echo_dat_" + filedat[ilc] for ilc in range(len(wav))
        ...
        if plottrace == 1:
            ...
            for idx in range(nft):
                ...
                try:
                    ...
                    t_trace = [
                        tit_trace[idx][id2] for id2 in range(npar) if id2 in idinc
                    ]
            ...
            gs1.update(
                left=0.1, right=0.9, wspace=0.05, hspace=0.0, bottom=0.1, top=0.99
            )
        ...
        if postplot == 1:
            logger.info("posterior distribution plots unavailable in this version")
