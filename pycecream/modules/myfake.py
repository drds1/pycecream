...
import os
import pycecream.modules.mytfb_quick as tfb
import pycecream.modules.myedlum as me
import pycecream.modules.myconvolve as mc
import pycecream.modules.mydisksim as mds
import pycecream.modules.myfake_amp as mfa
import pycecream.modules.myrandom as mr
import pycecream.modules.mylcgen as mlg
import pycecream.modules.myresample as mrs
...
def myfake(
    ...
    idxlo = np.where(tlc > tauhi)[0][
        0
    ]  # chop off lower limit where lookback is below the start time of the light curve
