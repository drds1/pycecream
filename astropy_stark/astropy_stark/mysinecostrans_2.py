...
# bpl [f0,alpha,beta] parameters for broken power law. If =[] just use random walk, else f0 break frequency, alpha first slope beta second slope
def sct(time,y,sig,freq=np.zeros(0),flo=-0.5,fhi=-2,dtres=-10,costrans=1,ploton = 1,bpl=[]):
